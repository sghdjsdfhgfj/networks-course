...
#### Демонстрация работы
Программу нужно запускать из-под sudo (как минимум на моем компьютере с Ubuntu).
<img width="1053" height="623" alt="image" src="https://github.com/user-attachments/assets/036c56f3-a420-4332-9952-908a9b79b9df" />
...
#### Демонстрация работы
<img width="1241" height="1017" alt="image" src="https://github.com/user-attachments/assets/f531e677-be2f-460d-b8db-d6a40b0fb15e" />
<img width="1241" height="1017" alt="image" src="https://github.com/user-attachments/assets/1b042e04-5280-4695-9897-ee1ca046c726" />
...
#### Демонстрация работы
Код программы лежит в репозитории.

Продемонстрировать работу программы у меня не получается, так как мой роутер перехватывает все пакеты с ошибками, не связанными с ttl, и отправляет свои ответы с кодом 0, указывающие на сам роутер.

Пример такой ситуации при использовании встроенной команды ping:

<img width="813" height="240" alt="image" src="https://github.com/user-attachments/assets/a01b67e7-d9fa-44b1-abd6-c8a53041b559" />
...
#### Демонстрация работы
Передаваемый файл и полные логи запуска клиента и сервера лежат в репозитории.

<img width="891" height="339" alt="image" src="https://github.com/user-attachments/assets/57e45595-fa7f-47f4-bc68-207b90ecfbf3" />
<img width="899" height="312" alt="image" src="https://github.com/user-attachments/assets/93e29c42-2cf0-42a0-ade1-06b3c6a982ff" />
<img width="900" height="70" alt="image" src="https://github.com/user-attachments/assets/6ab025ca-d9cc-4335-a9e1-dcbb73ad5c1f" />
